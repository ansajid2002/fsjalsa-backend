...
class InventoryController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function seller_inventory(Request $request)
    {
        $col_name = null;
        $query = null;
        $seller_id = null;
        ...
        return view('inventory.index', compact('products','type', 'col_name', 'query', 'seller_id', 'sort_search'));
    }


    public function get_products_stock(Request $request)
    {
        $products = Product::where('id', $request->id)->get();
        $product_stock = ProductStock::where('product_id', $request->id)->get();

        // return $products;
        return compact('products', 'product_stock');
    }
    ...
    public function store(Request $request)
    {
        ...
        $product->pincode_by = Auth::user()->pincode;
     ...
     * @return \Illuminate\Http\Response
     */
    public function seller_inventory_edit($id)
    {
        $product = Product::findOrFail(decrypt($id));
        $tags = json_decode($product->tags);
        $categories = Category::all();
        return view('inventory.edit', compact('product', 'categories', 'tags'));
    }
