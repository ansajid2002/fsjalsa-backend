...
<nav id="mainnav-container">
    <div id="mainnav" style="background: #093880">
                ...
                <div class="nano-content">
                    ...
                    <ul id="mainnav-menu" class="list-group">
                        ...
                        <li class="{{ areActiveRoutes(['admin.dashboard'])}}">
                            ...
                            @if(Auth::user()->user_type == 'staff' && Auth::user()->staff->role->name == 'DeliveryBoy')
                            <li class="">
                                <a class="nav-link" href="{{ route('deliveryboy.order.pending') }}">
                                <i class="fa fa-tasks" aria-hidden="true"></i>
                                    <span class="menu-title">{{translate('Pending Order')}}</span>
                                </a>
                            </li>
                            @endif
                            @if(Auth::user()->user_type == 'staff' && Auth::user()->staff->role->name == 'DeliveryBoy')
                            <li class="">
                                <a class="nav-link" href="{{ route('deliveryboy.order.complete') }}">
                                    <i class="fa fa-check" aria-hidden="true"></i>
                                    <span class="menu-title">{{translate('Completed Order')}}</span>
                                </a>
                            </li>
                            @endif
                            ...
                            <li>
                                <a href="#">
                                    ...
                                    <span class="menu-title">{{translate('Vendor Management')}}</span>
                                    <i class="arrow"></i>
                                </a>
                            ...
                            <ul class="collapse">
                                    <li class="{{ areActiveRoutes(['sellers.index', 'sellers.create', 'sellers.edit', 'sellers.payment_history','sellers.approved','sellers.profile_modal'])}}">
                                        ...
                                        @endphp
                                        <a class="nav-link" href="{{route('sellers.index')}}">{{translate('Vendor List')}} @if($sellers > 0)<span class="pull-right badge badge-info">{{ $sellers }}</span> @endif</a>
                                    </li>
                                    <li class="{{ areActiveRoutes(['withdraw_requests_all'])}}">
                                        <a class="nav-link" href="{{ route('withdraw_requests_all') }}">{{translate('Vendor Withdraw Requests')}}</a>
                                    </li>
                                    <li class="{{ areActiveRoutes(['sellers.payment_histories'])}}">
                                        <a class="nav-link" href="{{ route('sellers.payment_histories') }}">{{translate('Vendor Payments')}}</a>
                                    </li>
                                    <li class="{{ areActiveRoutes(['business_settings.vendor_commission'])}}">
                                        <a class="nav-link" href="{{ route('business_settings.vendor_commission') }}">{{translate('Vendor Commission')}}</a>
                                    </li>
                                    {{--
                                        <li class="{{ areActiveRoutes(['seller_verification_form.index'])}}">
                                        <a class="nav-link" href="{{route('seller_verification_form.index')}}">{{translate('Vendor Verification Form')}}</a>
                                    </li>
                                    --}}
                                    @if (\App\Addon::where('unique_identifier', 'seller_subscription')->first() != null && \App\Addon::where('unique_identifier', 'seller_subscription')->first()->activated)
                                        <li class="{{ areActiveRoutes(['seller_packages.index', 'seller_packages.create', 'seller_packages.edit'])}}">
                                            <a class="nav-link" href="{{ route('seller_packages.index') }}">{{translate('Vendor Packages')}}</a>
                                        </li>
                                    @endif
                                </ul>
                            </li> 
                            @endif
                                ...
                                <li>
                                    <a href="#">
                                        ...
                                        <span class="menu-title">{{translate('Category Management')}}</span>
                                        <i class="arrow"></i>
                                    </a>
                                    ...
                                    <ul class="collapse">
                                        ...
                                        <li class="{{ areActiveRoutes(['categories.index', 'categories.create', 'categories.edit'])}}">
                                            <a class="nav-link" href="{{route('categories.index')}}">{{translate('Base Category')}}</a>
                                        </li>
                                        <li class="{{ areActiveRoutes(['subcategories.index', 'subcategories.create', 'subcategories.edit'])}}">
                                            <a class="nav-link" href="{{route('subcategories.index')}}">{{translate('Sub category')}}</a>
                                        </li>
                                        <li class="{{ areActiveRoutes(['subsubcategories.index', 'subsubcategories.create', 'subsubcategories.edit'])}}">
                                            <a class="nav-link" href="{{route('subsubcategories.index')}}">{{translate('Sub Main category')}}</a>
                                        </li>
                            ...
                            @endif
                                ...
                                <li>
                                    <a href="#">
                                        ...
                                        <span class="menu-title">{{translate('Attribute')}}</span>
                                        <i class="arrow"></i>
                                    </a>
                                    ...
                                    <li class="{{ areActiveRoutes(['attributes.index','attributes.create','attributes.edit'])}}">
                                        <a class="nav-link" href="{{route('attributes.index')}}">{{translate('Custom')}}</a>
                                    </li>
                                    <li class="{{ areActiveRoutes(['colors.index', 'colors.create', 'colors.edit'])}}">
                                            <a class="nav-link" href="{{route('colors.index')}}">{{translate('Color')}}</a>
                                        </li>
                                        <!-- <li class="{{ areActiveRoutes(['categories.index', 'categories.create', 'categories.edit'])}}">
                                            <a class="nav-link" href="{{route('categories.index')}}">{{translate('Size')}}</a>
                                        </li> -->
                                        {{--
                                        <li class="">
                                            <a class="nav-link" href="">{{translate('Default')}}</a>
                                        </li>
                                        --}}
                                        <!-- <li class="{{ areActiveRoutes(['subcategories.index', 'subcategories.create', 'subcategories.edit'])}}">
                                            <a class="nav-link" href="{{route('subcategories.index')}}">{{translate('Default')}}</a>
                                        </li>
                                        <li class="{{ areActiveRoutes(['subsubcategories.index', 'subsubcategories.create', 'subsubcategories.edit'])}}">
                                            <a class="nav-link" href="{{route('subsubcategories.index')}}">{{translate('Custom')}}</a>
                                        </li> -->
                            ...
                            @if(\App\BusinessSetting::where('type', 'vendor_system_activation')->first()->value == 1)
                                <li class="{{ areActiveRoutes(['products.seller', 'products.seller.edit'])}}">
                                    ...
                                    <span class="menu-title">{{translate('Product Management')}}</span>
                                    </a>
                                </li>
                                <li class="">
                                    <a class="nav-link" href="{{route('seller.inventory')}}">
                                    <i class="fa fa-cart-plus"></i>
                                    <span class="menu-title">{{translate('Inventory Management')}}</span>
                                    </a>
                                </li>
                            @endif
                            ...
                            <li class="{{ areActiveRoutes(['orders.index.admin', 'orders.show'])}}">
                                <a class="nav-link" href="{{ route('orders.index.admin') }}">
                                    ...
                                    <span class="menu-title">{{translate('Order Management')}} @if($orders > 0)<span class="pull-right badge badge-info">{{ $orders }}</span>@endif</span>
                                </a>
                            </li>
                            ...
                            {{--
                                ...
                                <li>
                                    <a href="#">
                                        ...
                                        <span class="menu-title">{{translate('Returns')}}</span>
                                        <i class="arrow"></i>
                                    </a>
                                    ...
                                    <li class="">
                                            <a class="nav-link" href="">{{translate('Customer Cancelled Orders')}}</a>
                                        </li>
                                        <li class="">
                                            <a class="nav-link" href="">{{translate('Customer Return Orders')}}</a>
                                        </li>
                                        <li class="">
                                            <a class="nav-link" href="">{{translate('Exchange Orders')}}</a>
                                        </li>
                                        <li class="">
                                            <a class="nav-link" href="">{{translate('RTO')}}</a>
                                        </li>
                                        <li class="">
                                            <a class="nav-link" href="">{{translate('Claims')}}</a>
                                        </li>
                             ...
                             @if(Auth::user()->user_type == 'admin' || in_array('1', json_decode(Auth::user()->staff->role->permissions)))
                                <li>
                                    <a href="#">
                                        ...
                                        <span class="menu-title">{{translate('Payment')}}</span>
                                        <i class="arrow"></i>
                                    </a>
                                    ...
                                    <li class="{{ areActiveRoutes(['currency.index'])}}">
                                        ...
                                        <li class="">
                                            <a class="nav-link" href="">{{translate('Vendor Payment')}}</a>
                                        </li>
                                        <li class="">
                                            <a class="nav-link" href="">{{translate('Upload Commission Invoice')}}</a>
                                        </li>
                                        <li class="">
                                            <a class="nav-link" href="">{{translate('Customer Payment')}}</a>
                                        </li>                                     
                                    </ul>
                                </li>
                            @endif
                                ...
                                <li>
                                    <a href="#">
                                        <i class="fa fa-paw"></i>
                                        <span class="menu-title">{{translate('Marketing')}}</span>
                                        <i class="arrow"></i>
                                    </a>
                                    ...
                                    <li class="">
                                        <a class="nav-link" href="">{{translate('Collections')}}</a>
                                    </li>
                                        <li class="">
                                            <a class="nav-link" href="">{{translate('Internal Campaign')}}</a>
                                        </li>
                                        ...
                                        <li class="{{ areActiveRoutes(['flash_deals.index', 'flash_deals.create', 'flash_deals.edit'])}}">
                                            <a class="nav-link" href="{{ route('flash_deals.index') }}">{{translate('Create Deals')}}</a>
                                        </li>    
                                        <li class="">
                                            <a class="nav-link" href="">{{translate('Product Position')}}</a>
                                        </li>   
                                        
                                        <li class="{{ areActiveRoutes(['newsletters.index'])}}">
                                        <a class="nav-link" href="{{route('newsletters.index')}}">{{translate('Popup')}}</a>
                                    </li>
                                        <li class="">
                                            <a class="nav-link" href="">{{translate('Stitching Promo')}}</a>
                                        </li> 
                            ...
                            <li>
                                ...
                                <ul class="collapse">
                                    ...
                                    {{--
                                    <li class="{{ areActiveRoutes(['customers.index'])}}">
                                        <a class="nav-link" href="{{ route('customers.index') }}">{{translate('Abandon Cart')}}</a>
                                    </li>
                                    --}}
                            ...
                            <li class="{{ areActiveRoutes(['support_ticket.admin_index', 'support_ticket.admin_show'])}}">
                                <a class="nav-link" href="{{ route('support_ticket.admin_index') }}">{{translate('Support Ticket')}} 
                                    @if($support_ticket > 0)<span class="pull-right badge badge-info">{{ $support_ticket }}</span>@endif
                                </a>
                            </li>
                            @endif
                            ...
                            <!-- <li>
                                <a href="add-outside-user">
                                    <i class="fa fa-user-plus"></i>
                                    <span class="menu-title">{{translate('Add Outside Users')}}</span>
                              ...
                              @if(Auth::user()->user_type == 'admin' || in_array('1', json_decode(Auth::user()->staff->role->permissions)))
                                <li>
                                    <a href="#">
                                        ...
                                        <span class="menu-title">{{translate('Notification')}}</span>
                                        <i class="arrow"></i>
                                    </a>
                                    ...
                                    <li class="">
                                        <a class="nav-link" href="">{{translate('Consumer')}}</a>
                                    </li>
                                        <li class="">
                                            <a class="nav-link" href="">{{translate('Seller')}}</a>
                                        </li>                                                                            
                                    </ul>
                                </li>
                            @endif
                            ...
                            <li class="">
                                <a class="nav-link" href="">
                                    <i class="fa fa-bolt"></i>
                                    <span class="menu-title">{{translate('Enquiry Form')}}</span>
                                </a>
                            </li>
                            @endif
                            --}}
                            ...
                            <!-- @if(Auth::user()->user_type == 'admin' || in_array('97', json_decode(Auth::user()->staff->role->permissions)))
                            <li>
                            <a class="nav-link" href="{{ route('delivery.deliveryboy.list') }}">
                            ...
                            <li>
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class="">
                                        <a class="nav-link" href="">{{translate('Newsletters')}}</a>
                                    </li>
