<header id="navbar">
    <div id="navbar-container" class="boxed">
        ...
        <div class="navbar-header" style="background: #081831">
            <a href="{{route('admin.dashboard')}}" class="navbar-brand">
                ...
                @endif
                <div class="brand-title" style="background: #081831">
        ...
        <div class="navbar-content">
            ...
            <ul class="nav navbar-top-links">
                ...
                @if (\App\Addon::where('unique_identifier', 'pos_system')->first() != null && \App\Addon::where('unique_identifier', 'pos_system')->first()->activated && true === false)
                ...
                <li id="dropdown-user" class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right panel-default">
                        <ul class="head-list">
                          ...
                          @else
                            @if(Auth::user()->staff->role->name == "DeliveryBoy")
                            <li>
                                <a href="/serviceBoyLogout"><i class="demo-pli-unlock icon-lg icon-fw"></i> {{translate('Logout')}}</a>
                            </li>
                            @else
                            <li>
                                <a href="{{ route('logout')}}"><i class="demo-pli-unlock icon-lg icon-fw"></i> {{translate('Logout')}}</a>
