            ...
            <!-- <div class="container"> -->
                <div class="px-2 py-4 p-md-4 bg-white shadow-sm">
                    ...
                    <div class="caorusel-box arrow-round gutters-5">
                        ...
                        @foreach (filter_products(\App\Product::where('published', 1)->where('category_id', $homeCategory->category->id))->where('pincode_by',Session::get('pincode_of_session'))->orWhere('pincode_by',"admin")->latest()->limit(12)->get() as $key => $product)
