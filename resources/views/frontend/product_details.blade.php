        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-9">
                    ...
                    <div class="product-desc-tab bg-white  mb-3">
                    ...
                    <div class="product-desc-tab bg-white mb-3">
                        <div class="tabs tabs--style-2">
                            <ul class="nav nav-tabs justify-content-center sticky-top bg-white">
                                  <li class="nav-item">
                                    <a href="#tab_default_4" data-toggle="tab" class="nav-link text-uppercase strong-600 active show">{{ translate('Rating and Reviews')}}</a>
                                </li>
                            </ul>
                                        ...
                                        @foreach ($detailedProduct->reviews as $key => $review)
                                            <div class="block block-comment">
                                                ...
                                                <div class="block-image">
                                                    <img src="{{ asset($review->user->avatar_original) }}" data-src="{{ asset($review->user->avatar_original) }}" class="rounded-circle lazyload">
                                                </div>
                                                @else
                                                <div class="block-image">
                                                    <img src="https://cdn.icon-icons.com/icons2/1378/PNG/512/avatardefault_92824.png" data-src="https://cdn.icon-icons.com/icons2/1378/PNG/512/avatardefault_92824.png" class="rounded-circle lazyload">
                                                </div>
                                                @endif
