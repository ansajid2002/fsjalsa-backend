                        ...
                        <form id="shop" class="" action="{{ route('shops.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label>Hotel/{{ translate('Shop Name')}} <span class="required-star">*</span></label>
                                        </div>
                                        <div class="col-md-10">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label>Shop/Hotel {{ translate('Logo')}}</label>
                                        </div>
                                        <div class="col-md-10">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="number" class="form-control mb-3" placeholder="Pincode"  name="pincode" required>
                                        </div>
                                    </div>
                                    <center><b style="color:red">please enter a valid pincode because it help your Shop/Hotel to index properly in user location</b></center>
                                </div>
                            </div>
