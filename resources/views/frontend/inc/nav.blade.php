...
<div class="header bg-white">
   ...
   <!--  <div class="top-navbar">
    ...
    <!-- end mobile menu -->
    @if (Auth::check())
    <div class="position-relative logo-bar-area d-lg-none d-md-none">
        @else
    <div class="position-relative logo-bar-area d-none">
    @endif
        <div class="">
            <div class="container">
                ...
                @if (Auth::check())
                    <div class="col-lg-3 col-8">
                        ...
                        <div class="d-flex" style="display: flex;justify-content: center;align-items: center">
                            ...
                            <!-- Brand/Logo -->
                            <a class="navbar-brand w-100" href="{{ route('dashboard') }}">
                                @php
                           ...
                           {{-- @if(Route::currentRouteName() != 'categories.all')
                    ...
                    <div class="col-lg-9 col-4 float-right">
                    {{--<div class="d-flex w-100">
                            <div class="search-box flex-grow-1 px-4">
                                <form action="{{ route('search') }}" method="GET">
                                    <div class="d-flex position-relative">
                                        ...
                                        <div class="form-group category-select d-none .d-md-none .d-lg-none d-xl-none">
                            ...
                            <div class="logo-bar-icons float-right">
                                     ...
                                     <a href="{{ route('compare') }}" class="nav-box-link">
                                         ...
                                         @if (Auth::check() && Auth::user()->user_type != 'seller')
                                          <div class="col-lg-12 d-flex">
                                            <div class="mx-4">
                                                <a style="color: #777" href="{{ route('dashboard') }}" class="top-bar-item"><b><i class="fa fa-dashboard"></i> {{ translate('My Panel')}}</b></a>
                                            </div>
                                            <div>
                                                <a style="color: #777" href="{{ route('logout') }}" class="top-bar-item"><b><i class="fa fa-sign-out" aria-hidden="true"></i> {{ translate('Logout')}}</b></a>
                                            </div>
                                        </div>  
                                        @endif
                                            @else
                                            <div class="col-lg-12 d-flex">
                                            <div class="mx-4">
                                                <a style="color: #777" href="{{ route('user.login') }}" class="top-bar-item"><b><i class="fa fa-sign-in" aria-hidden="true"></i> {{ translate('Login')}}</b></a>
                                            </div>
                                            <div>
                                                <a style="color: #777" href="{{ route('user.registration') }}" class="top-bar-item"><b><i class="fa fa-user-plus" aria-hidden="true"></i> {{ translate('Registration')}}</b></a>
                                            </div>
                                        </div>
                                            @endauth
                                    </div>
        ...
        <div style="padding-top:8px;display:flex;justify-content:center">
          <center class="sx_bem">
          @foreach (\App\Category::all() as $key => $category)
            <span style="padding-left:15px;padding-right:15px;color:black"><a href="/search?category={{ __($category->slug) }}"><b>{{ __($category->name) }}</b></a></span>
          @endforeach
         </center>
        </div>
        @endif -->
