    ...
    <section class="gry-bg py-4 profile">
        <div class="container-fluid">
            <div class="row cols-xs-space cols-sm-space cols-md-space">
                ...
                <div class="col-lg-9 card content-card">
                        ...
                        <div class="card no-border mt-4">
                            ...
                            <div class="card-body">
                                <table class="table table-sm table-hover table-responsive-md">
                                    <thead>
                                        <tr>
                                            ...
                                            <th><center>{{ translate('Status')}}</center></th>
                                    ...
                                    <tbody>
                                        @foreach ($products as $key => $product)
                                            <tr>
                                                ...
                                                <td>
                                <span> 
                                    @if($product->published == 0) Pending @endif 
                                ...
                                Published 
                                    ...
                                    @endif 
                                    @if($product->published == 2) In Review @endif 
                                    @if($product->published == 3) 
                                    <center>
                                    Reject 
                                    <br>
                                    <span class="text-danger">{{ $product->reject_reason }}</span>                                    </center>                                  
