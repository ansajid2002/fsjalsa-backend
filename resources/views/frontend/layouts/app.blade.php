...
.rdx_srx_child >li >a:hover{
  color:#72bf40;
}
.rdx_srx::-webkit-scrollbar {
  display: none;
}
...
<!-- MAIN WRAPPER -->
<div class=" shop-cards shop-tech gry-bg">
...
<script>
    ...
    function cartQuantityInitialize(){
     ...
     $("#sidebarCollapse").on("click", function() {
        ...
        // $('.content-card').addClass("collapse-card");
        $('#sidebarDiv').toggleClass("col-lg-3");
     
        $('#sidebarDiv').toggleClass("col-lg-1");
        $('.content-card').toggleClass("col-lg-9");
        $('.content-card').toggleClass("col-lg-11");
        $('#sidebar ul li a').toggleClass("text-center");
        // $('#sidebar ul li a').toggleClass("text-left");
        /* $(".content-card").toggleClass("collapse-card");
        $(this).toggleClass("collapse-card"); */
        $('.category-name').toggleClass('d-none');
        // $('.category-name').toggleClass('d-block');
    });
</script>
@yield('script')
