...
// });
// Route::get('/sendSmsForRegOtpDel','HomeController@sendSmsForDeliveryBoyRegister');
// Route::get('/sendSmsForLoginOtpDel','HomeController@sendSmsForDeliveryBoyLogin');
// Route::get('/verifyDeliveryBoyOtp','HomeController@verifyDeliveryBoyOtp');
// Route::get('/verifyDeliveryBoyOtpLogin','HomeController@verifyDeliveryBoyOtpLogin');
// Route::post('/register-deliveryboy','HomeController@registerDeliveryboy')->name('register-deliveryboy');
Route::get('/create/service-person','HomeController@createServicePerson')->name('create.serviceperson');
// Route::get('/login/service-person','HomeController@loginServicePerson')->name('login.serviceperson');
// Route::get('/serviceBoyLogout','HomeController@serviceBoyLogout')->name('serviceBoyLogout');



// Route::post('/create/service-personin','HomeController@createServicePersonIn');
// Route::get('/vv_web_location/{picode}','HomeController@vv_web_location');
...
Route::get('/seller/registration', 'SellerController@registration')->name('seller.registration');
Route::post('/seller/store', 'SellerController@store')->name('seller.store');
Route::get('/seller/account_verification', 'SellerController@accountVerification')->name('seller.account_verification');
...
//Home Page
// Route::get('/doner', 'HomeController@doner');
...
// 	Route::resource('wishlists','WishlistController');
	Route::post('/wishlists/remove', 'WishlistController@remove')->name('wishlists.index');
// 	Route::post('/wishlists/remove', 'WishlistController@remove')->name('wishlists.remove');

// 	Route::get('/wallet', 'WalletController@index')->name('wallet.index');
// 	Route::post('/recharge', 'WalletController@recharge')->name('wallet.recharge');

	Route::group(['middleware' => ['seller', 'is_verified']], function(){
...
Route::group(['prefix' =>'seller', 'middleware' => ['seller', 'is_verified']], function(){
	Route::get('/products', 'HomeController@seller_product_list')->name('seller.products')->middleware('verified');
...
Route::group(['middleware' => ['auth']], function(){
	...
	// Route::post('/products/status', 'ProductController@updatePublished')->name('products.status');
	// Route::post('/products/reason', 'ProductController@updatePublished')->name('products.reason');
	Route::post('/products/stcck', 'ProductController@get_products_stock')->name('products.stock');
  Route::post('/goForPayment','HomeController@goForRecharge')->name('goForPayment');
	Route::post('/completePaymentForRec','HomeController@completePaymentForRec')->name('completePaymentForRec');
	...
	Route::get('/orders/destroy/{id}', 'OrderController@destroy')->name('orders.destroy')->middleware('verified');
	Route::post('/orders/details', 'OrderController@order_details')->name('orders.details')->middleware('verified');
	Route::post('/orders/update_delivery_status', 'OrderController@update_delivery_status')->name('orders.update_delivery_status')->middleware('verified');
	Route::post('/orders/update_delivery_boy', 'OrderController@update_delivery_boy')->name('orders.update_delivery_boy')->middleware('verified');
	Route::post('/orders/update_payment_status', 'OrderController@update_payment_status')->name('orders.update_payment_status')->middleware('verified');
	});
