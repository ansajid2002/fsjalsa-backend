...
Route::get('/deliveryboy/order/pending', 'HomeController@deliveryOrderPending')->name('deliveryboy.order.pending')->middleware(['auth', 'admin']);
Route::get('/deliveryboy/order/pending/view/{id}', 'HomeController@deliveryOrderPendingView')->name('deliveryboy.order.pending.view')->middleware(['auth', 'admin']);
Route::get('/deliveryDoneDeliveryBoy/{id}', 'HomeController@deliveryDoneDeliveryBoy')->middleware(['auth', 'admin']);
Route::get('/cashCollectedDeliveryBoy/{id}', 'HomeController@cashCollectedDeliveryBoy')->middleware(['auth', 'admin']);
Route::get('/deliveryboy/order/complete', 'HomeController@deliveryOrderComplete')->name('deliveryboy.order.complete')->middleware(['auth', 'admin']);
Route::get('/delivery/deliveryboy/list', 'OrderController@deliveryDeliveryboy')->name('delivery.deliveryboy.list')->middleware(['auth', 'admin']);
Route::get('/verifyDeliveryBoyDone/{id}', 'OrderController@verifyDeliveryBoyDone')->middleware(['auth', 'admin']);
...
Route::get('/getRechargeDetail', 'HomeController@getRechargeDetail')->middleware(['auth', 'admin']);
Route::get('refundUser/{id}','HomeController@refunding')->name('refund-user')->middleware(['auth', 'admin']);
Route::group(['prefix' =>'admin', 'middleware' => ['auth', 'admin']], function(){
	Route::get('/colors', 'ColorAttributeController@index')->name('colors.index');
	Route::resource('colors','ColorAttributeController');
	Route::get('/colors/create','ColorAttributeController@create')->name('colors.create');
	Route::get('/colors/admin/{id}/edit','ColorAttributeController@edit')->name('colors.admin.edit');
	Route::post('/colors/update', 'ColorAttributeController@update')->name('colors.update');
	Route::get('/colors/destroy/{id}', 'ColorAttributeController@destroy')->name('colors.destroy');
	...
	Route::get('/inventory','InventoryController@seller_inventory')->name('seller.inventory');
	Route::get('/inventory/seller/{id}/edit','InventoryController@seller_inventory_edit')->name('seller.inventory.edit');
	Route::post('/inventory/stock', 'InventoryController@get_products_stock')->name('inventory.stock');
	...
	Route::get('/getSingleReview/{id}', 'ReviewController@getSingleReview');
	Route::post('/updateUserReview', 'ReviewController@updateUserReview');
	Route::get('/add-outside-user', 'ReviewController@addOutsideUser');
	Route::post('/add-outside-user', 'ReviewController@addOutsideUserYes');
	Route::get('/deleteOutsideUser/{id}', 'ReviewController@deleteOutsideUser');
